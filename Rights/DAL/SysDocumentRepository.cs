...
namespace Langben.DAL
{
    ...
    public partial class SysDocumentRepository : BaseRepository<SysDocument>, IDisposable
    {
        ...
        /// <returns></returns>      
        public IQueryable<SysDocument> DaoChuData(SysEntities db, string order, string sort, string search, params object[] listQuery)
        {
        ...
        /// <param name="id">主键</param>
        /// <returns>文档管理</returns>
        public SysDocument GetById(SysEntities db, string id)
        { 
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<SysDepartment> GetRefSysDepartment(SysEntities db, string id)
        {
                return from m in db.SysDocument
        ...
        /// <param name="id">主键</param>
        /// <returns>外键实体集合</returns>
        public IQueryable<SysDepartment> GetRefSysDepartment(SysEntities db)
        {
            return from m in db.SysDocument
                   from f in m.SysDepartment
                   select f;
